      ...
      <div class="main-panel" style="width: calc(100% - 2px);">
        ...
        <div>
                <div class = "float-left">
                  <a href ="/user" type="button" class="btn btn-warning btn-icon-text" style="background-color:#D8B237">
                  <i class="fa fa-arrow-left" aria-hidden="true"></i>                                                  
                          &nbsp Back
                    </a>
                </div>
                <h1 style="text-align:center;">Update Type of User
                </h1> 
        </div>
            <div class="card">
                <div class="card-body">
                  ...
                  @csrf
                    <div class="form-group">
                      <label>User ID</label>
                      <input type="text" class="form-control" name= "user_id" value="{{$cust->id}}" placeholder="id" readonly>
                    </div>
                    <div class="form-group">
                      <label>Full Name</label>
                      <input type="text" class="form-control" name= "name" id="name" value="{{$cust->name}}" placeholder="Name" readonly>
                    </div>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" class="form-control" name= "email" id="name" value="{{$cust->email}}" placeholder="Email" readonly>
                    </div>
                    <div class="form-group">
                      <label>User Type</label>
                      <select class="form-control" name="usertype">
                            <option value="1" @if($cust->usertype == '1') selected @endif>Admin</option>
                            <option value="0" @if($cust->usertype == '0') selected @endif>Customer</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <br>
