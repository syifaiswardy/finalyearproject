    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel" style="width: calc(100% - 2px);">
        ...
        <div>
                ...
                <h1 style="text-align:center;">Update Rooms
                </h1> 
        </div>
            <div class="card" style = "min-height:50%;">
                <div class="card-body" >
                  <!-- <h4 class="card-title">Book Now!</h4> -->
                  <form class="forms-sample" action = "/updateRoom" method="post">
                  @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name= "room_name" id="name" value="{{$room->room_name}}" placeholder="Equipment Name" required>
                    </div>
